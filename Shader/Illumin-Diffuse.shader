...
void main ()
{
  ...
  c_1.w = c_3.w;
  c_1.xyz = (c_3.xyz + (tmpvar_2.xyz * xlv_TEXCOORD2));
  c_1.xyz = (c_1.xyz + (tmpvar_2.xyz * texture (_Illum, xlv_TEXCOORD0.zw).w));
  _glesFragData[0] = c_1;
}
...
void main ()
{
  ...
  lowp vec3 tmpvar_5;
  tmpvar_5 = (tmpvar_4.xyz * texture (_Illum, xlv_TEXCOORD0.zw).w);
  lowp vec4 tmpvar_6;
...
void main ()
{
  ...
  lowp vec3 tmpvar_8;
  tmpvar_8 = (tmpvar_7.xyz * texture (_Illum, xlv_TEXCOORD0.zw).w);
  lowp vec4 tmpvar_9;
