...
Properties {
 ...
 _RimPower ("Rim Strength", Float) = 1
}
SubShader { 
...
void main ()
{
  ...
  tmpvar_5 = clamp (dot (normalize(xlv_TEXCOORD1), xlv_TEXCOORD2), 0.0, 1.0);
  tmpvar_4 = tmpvar_5;
  mediump vec3 tmpvar_6;
  lowp vec3 x_7;
  x_7 = (tmpvar_3.xyz * ((_RimColor * 2.0) - 0.5).xyz);
  lowp vec3 y_8;
  y_8 = (tmpvar_3.xyz * _Color.xyz);
  tmpvar_6 = mix (x_7, y_8, vec3(pow (tmpvar_4, _RimPower)));
  tmpvar_2 = tmpvar_6;
  lowp float x_9;
  x_9 = (tmpvar_3.w - 0.5);
  if ((x_9 < 0.0)) {
...
void main ()
{
  ...
  xlv_TEXCOORD1 = (_WorldSpaceCameraPos - cse_4.xyz);
  xlv_TEXCOORD2 = tmpvar_1;
  xlv_TEXCOORD3 = ((_glesMultiTexCoord1.xy * unity_LightmapST.xy) + unity_LightmapST.zw);
...
void main ()
{
  lowp vec4 res_1;
  lowp float x_2;
  x_2 = (texture2D (_MainTex, xlv_TEXCOORD0).w - 0.5);
  if ((x_2 < 0.0)) {
    discard;
  };
...
void main ()
{
  lowp vec4 res_1;
  lowp float x_2;
  x_2 = (texture (_MainTex, xlv_TEXCOORD0).w - 0.5);
  if ((x_2 < 0.0)) {
    discard;
  };
  res_1.xyz = ((xlv_TEXCOORD1 * 0.5) + 0.5);
...
void main ()
{
  ...
  tmpvar_7 = clamp (dot (normalize(xlv_TEXCOORD1), xlv_TEXCOORD3), 0.0, 1.0);
  tmpvar_6 = tmpvar_7;
  mediump vec3 tmpvar_8;
  lowp vec3 x_9;
  x_9 = (tmpvar_5.xyz * ((_RimColor * 2.0) - 0.5).xyz);
  lowp vec3 y_10;
  y_10 = (tmpvar_5.xyz * _Color.xyz);
  tmpvar_8 = mix (x_9, y_10, vec3(pow (tmpvar_6, _RimPower)));
  tmpvar_4 = tmpvar_8;
  lowp float x_11;
  x_11 = (tmpvar_5.w - 0.5);
  if ((x_11 < 0.0)) {
...
void main ()
{
  ...
  tmpvar_12 = (tmpvar_11 * (tmpvar_2 * unity_Scale.w));
  tmpvar_3 = tmpvar_12;
...
void main ()
{
  ...
  tmpvar_10 = clamp (dot (normalize(xlv_TEXCOORD1), xlv_TEXCOORD3), 0.0, 1.0);
  tmpvar_9 = tmpvar_10;
  mediump vec3 tmpvar_11;
  lowp vec3 x_12;
  x_12 = (tmpvar_8.xyz * ((_RimColor * 2.0) - 0.5).xyz);
  lowp vec3 y_13;
  y_13 = (tmpvar_8.xyz * _Color.xyz);
  tmpvar_11 = mix (x_12, y_13, vec3(pow (tmpvar_9, _RimPower)));
  tmpvar_7 = tmpvar_11;
  lowp float x_14;
  x_14 = (tmpvar_8.w - 0.5);
  if ((x_14 < 0.0)) {
...
void main ()
{
  ...
  lowp vec4 tmpvar_15;
  tmpvar_15 = textureProj (_LightBuffer, xlv_TEXCOORD2);
  light_6 = tmpvar_15;
  mediump vec4 tmpvar_16;
  tmpvar_16 = -(log2(max (light_6, vec4(0.001, 0.001, 0.001, 0.001))));
  light_6.w = tmpvar_16.w;
  ...
  lmFull_4 = tmpvar_18;
  lowp vec3 tmpvar_19;
  tmpvar_19 = (2.0 * texture (unity_LightmapInd, xlv_TEXCOORD4).xyz);
  lmIndirect_3 = tmpvar_19;
  light_6.xyz = (tmpvar_16.xyz + mix (lmIndirect_3, lmFull_4, vec3(clamp (lmFade_5, 0.0, 1.0))));
  lowp vec4 c_20;
  c_20.xyz = vec3(0.0, 0.0, 0.0);
...
void main ()
{
  ...
  tmpvar_6 = clamp (dot (normalize(xlv_TEXCOORD1), xlv_TEXCOORD3), 0.0, 1.0);
  tmpvar_5 = tmpvar_6;
  mediump vec3 tmpvar_7;
  lowp vec3 x_8;
  x_8 = (tmpvar_4.xyz * ((_RimColor * 2.0) - 0.5).xyz);
  lowp vec3 y_9;
  y_9 = (tmpvar_4.xyz * _Color.xyz);
  tmpvar_7 = mix (x_8, y_9, vec3(pow (tmpvar_5, _RimPower)));
  tmpvar_3 = tmpvar_7;
  lowp float x_10;
  x_10 = (tmpvar_4.w - 0.5);
  if ((x_10 < 0.0)) {
...
{
  lowp float x_1;
  x_1 = (texture2D (_MainTex, xlv_TEXCOORD1).w - 0.5);
  if ((x_1 < 0.0)) {
    discard;
  };
...
{
  lowp float x_1;
  x_1 = (texture (_MainTex, xlv_TEXCOORD1).w - 0.5);
  if ((x_1 < 0.0)) {
    discard;
  };
...
void main ()
{
  lowp vec4 tmpvar_1;
  lowp float x_2;
  x_2 = (texture2D (_MainTex, xlv_TEXCOORD1).w - 0.5);
  if ((x_2 < 0.0)) {
    discard;
  };
  highp vec4 tmpvar_3;
...
void main ()
{
  lowp vec4 tmpvar_1;
  lowp float x_2;
  x_2 = (texture (_MainTex, xlv_TEXCOORD1).w - 0.5);
  if ((x_2 < 0.0)) {
    discard;
  };
  highp vec4 tmpvar_3;
...
void main ()
{
  ...
  highp vec4 zNear_4;
  lowp float x_5;
  x_5 = (texture2D (_MainTex, xlv_TEXCOORD5).w - 0.5);
  if ((x_5 < 0.0)) {
    discard;
  };
  bvec4 tmpvar_6;
...
void main ()
{
  ...
  highp vec4 zNear_5;
  lowp float x_6;
  x_6 = (texture2D (_MainTex, xlv_TEXCOORD5).w - 0.5);
  if ((x_6 < 0.0)) {
    discard;
  };
  bvec4 tmpvar_7;
...
void main ()
{
  ...
  highp vec4 zNear_5;
  lowp float x_6;
  x_6 = (texture (_MainTex, xlv_TEXCOORD5).w - 0.5);
  if ((x_6 < 0.0)) {
    discard;
  };
  bvec4 tmpvar_7;
...
void main ()
{
  ...
  lowp float x_4;
  x_4 = (texture2D (_MainTex, xlv_TEXCOORD5).w - 0.5);
  if ((x_4 < 0.0)) {
    discard;
  };
  highp vec3 tmpvar_5;
...
void main ()
{
  ...
  highp vec4 cascadeWeights_4;
  lowp float x_5;
  x_5 = (texture (_MainTex, xlv_TEXCOORD5).w - 0.5);
  if ((x_5 < 0.0)) {
    discard;
  };
  highp vec3 tmpvar_6;
