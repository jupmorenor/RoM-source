...
void main ()
{
  ...
  lowp vec4 c_5;
  c_5.xyz = ((tmpvar_2.xyz * _LightColor0.xyz) * (max (0.0, 
...
void main ()
{
  ...
  tmpvar_5 = tmpvar_10;
  lowp vec4 c_11;
  c_11.xyz = ((tmpvar_2.xyz * _LightColor0.xyz) * ((
...
void main ()
{
  ...
  lowp vec4 c_10;
  c_10.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD1, lightDir_2))
   * atten_9) * 2.0));
  c_10.w = tmpvar_4;
  c_1.xyz = c_10.xyz;
...
void main ()
{
  lowp vec4 res_1;
  lowp float x_2;
  x_2 = ((texture (_MainTex, xlv_TEXCOORD0) * _Color).w - _Cutoff);
  if ((x_2 < 0.0)) {
    discard;
  };
  res_1.xyz = ((xlv_TEXCOORD1 * 0.5) + 0.5);
