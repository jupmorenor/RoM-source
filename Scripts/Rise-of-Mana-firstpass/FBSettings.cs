...
public class FBSettings : ScriptableObject
{
	...
	public int SelectedAppIndex => selectedAppIndex;
	...
	public static string[] AllAppIds => Instance.AppIds;

	public static string AppId => "752623444836539";

	public static bool IsValidAppId => AppId != null && AppId.Length > 0 && !AppId.Equals("0");
