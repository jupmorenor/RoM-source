...
public class UIRoot : MonoBehaviour
{
	...
	[HideInInspector]
	public int minimumHeight = 640;

	[HideInInspector]
	public int maximumHeight = 1600;
	...
	private void Awake()
	{
		...
		if (base.gameObject.GetComponent<UIRootSizeChanger>() == null)
		{
			base.gameObject.AddComponent<UIRootSizeChanger>();
		}
	}
