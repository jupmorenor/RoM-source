...
public static class NGUITools
{
	...
	public static GameObject InstantiateWithoutUIPanel(GameObject prefabObject)
	{
		GameObject gameObject = UnityEngine.Object.Instantiate(prefabObject) as GameObject;
		if ((bool)gameObject)
		{
			DestroyAllSameComponent<UIPanel>(gameObject);
		}
		return gameObject;
	}

	public static void DestroyAllSameComponent<T>(GameObject go) where T : Component
	{
	...
	public static UIPanel GetPanel(GameObject go)
	{
		UIWidget[] componentsInChildren = go.GetComponentsInChildren<UIWidget>();
	...
	public static void ClearSprite(UISprite sp)
	{
		if (sp != null)
		{
			sp.spriteName = string.Empty;
