...
public class UIDraggablePanel : IgnoreTimeScale
{
	...
	public bool restrictWhenPress = true;
	...
	public AbstractUIListBase uiListBase;

	public UIPanel panel => mPanel;

	public bool Pressed => mPressed;
	...
	public bool RestrictWithinBounds(bool instant)
	{
		...
		if (vector.magnitude > 0.001f)
		{
			...
			{
				SpringPanel.Begin(mPanel.gameObject, mTrans.localPosition + vector, springStrength);
			}
			else
			{
				MoveRelative(vector);
	...
	public void UpdateScrollbars(bool recalculateBounds)
	{
		...
		if (uiListBase == null && (horizontalScrollBar != null || verticalScrollBar != null))
		{
	...
	public void OnVerticalBar(UIScrollBar sb)
	{
		if (!mIgnoreCallbacks)
		{
			float x = ((!(horizontalScrollBar != null)) ? 0f : horizontalScrollBar.scrollValue);
	...
	public void Press(bool pressed)
	{
		...
		if (restrictWithinPanel && restrictWhenPress && mPanel.clipping != 0 && dragEffect == DragEffect.MomentumAndSpring)
		{
	...
	public void LateUpdate()
	{
		...
		if (showScrollBars != 0)
		{
			...
			if (verticalScrollBar != null && !verticalScrollBar.IsBeingDragged)
			{
			...
			if (horizontalScrollBar != null && !verticalScrollBar.IsBeingDragged)
			{
