...
[Serializable]
public class MShortcutIcons : MerlinMaster
{
	...
	public int _0024var_0024PosXIndex;

	public int _0024var_0024PosYIndex;

	public bool _0024var_0024EventShortcut;
	...
	[NonSerialized]
	private static Dictionary<int, MShortcutIcons> _0024mst_0024100 = new Dictionary<int, MShortcutIcons>();

	[NonSerialized]
	private static MShortcutIcons[] All_cache;
	...
	public string Bg => _0024var_0024Bg;
	...
	public int PosXIndex => _0024var_0024PosXIndex;

	public int PosYIndex => _0024var_0024PosYIndex;

	public bool EventShortcut => _0024var_0024EventShortcut;
	...
	public static MShortcutIcons[] All
	{
		get
		{
			MShortcutIcons[] result;
			if (All_cache == null)
			{
				MerlinMaster.GetHandler("MShortcutIcons");
				MShortcutIcons[] array = (MShortcutIcons[])Builtins.array(typeof(MShortcutIcons), _0024mst_0024100.Values);
				if (array.Length > 0)
				{
					All_cache = array;
					result = All_cache;
	...
	public static MShortcutIcons Get(int _id)
	{
		MerlinMaster.GetHandler("MShortcutIcons");
		return (!_0024mst_0024100.ContainsKey(_id)) ? null : _0024mst_0024100[_id];
	}

	public static void Unload()
	{
		_0024mst_0024100.Clear();
		All_cache = null;
	}

	public static MShortcutIcons New(Hashtable data)
	{
		object result;
		...
		{
			MShortcutIcons mShortcutIcons = Create(data);
			if (!_0024mst_0024100.ContainsKey(mShortcutIcons.Id))
			{
				_0024mst_0024100[mShortcutIcons.Id] = mShortcutIcons;
			}
			result = mShortcutIcons;
		}
		return (MShortcutIcons)result;
	}

	public static MShortcutIcons New2(string[] keys, object[] vals)
	{
		object result;
	...
	public static MShortcutIcons Entry(MShortcutIcons mst, object id)
	{
		object result;
		if (mst != null)
		{
			mst.setField("Id", id);
			_0024mst_0024100[RuntimeServices.UnboxInt32(id)] = mst;
			result = mst;
		}
		else
		{
	...
	public static void AddMst(MShortcutIcons mst)
	{
		if (mst != null)
		{
			_0024mst_0024100[mst.Id] = mst;
		}
	}

	public static MShortcutIcons Create(Hashtable data)
	{
		MShortcutIcons mShortcutIcons = new MShortcutIcons();
		MShortcutIcons result;
		if (data == null)
		{
			result = mShortcutIcons;
		...
		else
		{
			...
			while (enumerator.MoveNext())
			{
				...
				mShortcutIcons.setField((string)obj, data[current]);
			}
			result = mShortcutIcons;
		}
		return result;
	...
	public void setField(string key, object val)
	{
		...
		case "Icon":
			...
			break;
		case "Bg":
			_0024var_0024Bg = MasterBaseClass.ToStringValue(val);
			break;
		case "DisplayName":
		...
		case "ScaleY":
			...
			break;
		case "PosXIndex":
			_0024var_0024PosXIndex = MasterBaseClass.ToInt(val);
			break;
		case "PosYIndex":
			_0024var_0024PosYIndex = MasterBaseClass.ToInt(val);
			break;
		case "EventShortcut":
			_0024var_0024EventShortcut = MasterBaseClass.ToBool(val);
			break;
		case "Condition_1":
	...
	public static string[] KeyNameList()
	{
		...
		return (string[])RuntimeServices.AddArrays(typeof(string), lhs, new string[30]
		{
			"Id", "Progname", "Icon", "Bg", "DisplayName", "DisplayName_En", "AreaGroup", "DirectSceneName_1", "DirectSceneName_2", "ScaleX",
			"ScaleY", "PosXIndex", "PosYIndex", "EventShortcut", "Condition_1", "Condition_2", "Condition_3", "Condition_4", "Condition_5", "Condition_6",
					...
					else
					{
						...
						else
						{
							...
							else
							{
								if (vals[5] != null)
								{
									_0024var_0024DisplayName_En = vals[5];
								}
								if (length <= 6)
								{
									result = 6;
								...
								else
								{
									if (vals[6] != null)
									{
										_0024var_0024AreaGroup = MasterBaseClass.ParseInt(vals[6]);
									}
									if (length <= 7)
									{
										result = 7;
									...
									else
									{
										if (vals[7] != null)
										{
											_0024var_0024DirectSceneName_1 = vals[7];
										}
										if (length <= 8)
										{
											result = 8;
										...
										else
										{
											if (vals[8] != null)
											{
												_0024var_0024DirectSceneName_2 = vals[8];
											}
											if (length <= 9)
											{
												result = 9;
											...
											else
											{
												if (vals[9] != null)
												{
													_0024var_0024ScaleX = MasterBaseClass.ParseSingle(vals[9]);
												}
												if (length <= 10)
												{
													result = 10;
												...
												else
												{
													if (vals[10] != null)
													{
														_0024var_0024ScaleY = MasterBaseClass.ParseSingle(vals[10]);
													}
													if (length <= 11)
													{
														result = 11;
													...
													else
													{
														if (vals[11] != null)
														{
															_0024var_0024PosXIndex = MasterBaseClass.ParseInt(vals[11]);
														}
														if (length <= 12)
														{
															result = 12;
														...
														else
														{
															if (vals[12] != null)
															{
																_0024var_0024PosYIndex = MasterBaseClass.ParseInt(vals[12]);
															}
															if (length <= 13)
															{
																result = 13;
															...
															else
															{
																if (vals[13] != null)
																{
																	_0024var_0024EventShortcut = MasterBaseClass.ParseBool(vals[13]);
																}
																if (length <= 14)
																{
																	result = 14;
																...
																else
																{
																	if (vals[14] != null)
																	{
																		_0024var_0024Condition_1 = MasterBaseClass.ParseInt(vals[14]);
																	}
																	if (length <= 15)
																	{
																		result = 15;
																	...
																	else
																	{
																		if (vals[15] != null)
																		{
																			_0024var_0024Condition_2 = MasterBaseClass.ParseInt(vals[15]);
																		}
																		if (length <= 16)
																		{
																			result = 16;
																		...
																		else
																		{
																			if (vals[16] != null)
																			{
																				_0024var_0024Condition_3 = MasterBaseClass.ParseInt(vals[16]);
																			}
																			if (length <= 17)
																			{
																				result = 17;
																			...
																			else
																			{
																				if (vals[17] != null)
																				{
																					_0024var_0024Condition_4 = MasterBaseClass.ParseInt(vals[17]);
																				}
																				if (length <= 18)
																				{
																					result = 18;
																				...
																				else
																				{
																					if (vals[18] != null)
																					{
																						_0024var_0024Condition_5 = MasterBaseClass.ParseInt(vals[18]);
																					}
																					if (length <= 19)
																					{
																						result = 19;
																					...
																					else
																					{
																						if (vals[19] != null)
																						{
																							_0024var_0024Condition_6 = MasterBaseClass.ParseInt(vals[19]);
																						}
																						if (length <= 20)
																						{
																							result = 20;
																						...
																						else
																						{
																							if (vals[20] != null)
																							{
																								_0024var_0024Condition_7 = MasterBaseClass.ParseInt(vals[20]);
																							}
																							if (length <= 21)
																							{
																								result = 21;
																							...
																							else
																							{
																								if (vals[21] != null)
																								{
																									_0024var_0024Condition_8 = MasterBaseClass.ParseInt(vals[21]);
																								}
																								if (length <= 22)
																								{
																									result = 22;
																								...
																								else
																								{
																									if (vals[22] != null)
																									{
																										_0024var_0024NotCondition_1 = MasterBaseClass.ParseInt(vals[22]);
																									}
																									if (length <= 23)
																									{
																										result = 23;
																									...
																									else
																									{
																										if (vals[23] != null)
																										{
																											_0024var_0024NotCondition_2 = MasterBaseClass.ParseInt(vals[23]);
																										}
																										if (length <= 24)
																										{
																											result = 24;
																										...
																										else
																										{
																											if (vals[24] != null)
																											{
																												_0024var_0024NotCondition_3 = MasterBaseClass.ParseInt(vals[24]);
																											}
																											if (length <= 25)
																											{
																												result = 25;
																											...
																											else
																											{
																												if (vals[25] != null)
																												{
																													_0024var_0024NotCondition_4 = MasterBaseClass.ParseInt(vals[25]);
																												}
																												if (length <= 26)
																												{
																													result = 26;
																												...
																												else
																												{
																													if (vals[26] != null)
																													{
																														_0024var_0024NotCondition_5 = MasterBaseClass.ParseInt(vals[26]);
																													}
																													if (length <= 27)
																													{
																														result = 27;
																													...
																													else
																													{
																														if (vals[27] != null)
																														{
																															_0024var_0024NotCondition_6 = MasterBaseClass.ParseInt(vals[27]);
																														}
																														if (length <= 28)
																														{
																															result = 28;
																														...
																														else
																														{
																															if (vals[28] != null)
																															{
																																_0024var_0024NotCondition_7 = MasterBaseClass.ParseInt(vals[28]);
																															}
																															if (length <= 29)
																															{
																																result = 29;
																															...
																															else
																															{
																																if (vals[29] != null)
																																{
																																	_0024var_0024NotCondition_8 = MasterBaseClass.ParseInt(vals[29]);
																																}
																																int num = 30;
																																result = num;
																															}
