...
[Serializable]
public class MStoryBooks : MerlinMaster
{
	...
	[NonSerialized]
	private static Dictionary<int, MStoryBooks> _0024mst_002471 = new Dictionary<int, MStoryBooks>();

	[NonSerialized]
	private static MStoryBooks[] All_cache;
	...
	public static MStoryBooks[] All
	{
		get
		{
			...
			if (All_cache == null)
			{
				MerlinMaster.GetHandler("MStoryBooks");
				MStoryBooks[] array = (MStoryBooks[])Builtins.array(typeof(MStoryBooks), _0024mst_002471.Values);
				if (array.Length > 0)
				{
					All_cache = array;
					result = All_cache;
	...
	public static MStoryBooks Get(int _id)
	{
		MerlinMaster.GetHandler("MStoryBooks");
		return (!_0024mst_002471.ContainsKey(_id)) ? null : _0024mst_002471[_id];
	}

	public static void Unload()
	{
		_0024mst_002471.Clear();
		All_cache = null;
	}

	public static MStoryBooks New(Hashtable data)
	{
		object result;
		...
		{
			MStoryBooks mStoryBooks = Create(data);
			if (!_0024mst_002471.ContainsKey(mStoryBooks.Id))
			{
				_0024mst_002471[mStoryBooks.Id] = mStoryBooks;
			}
			result = mStoryBooks;
		}
		return (MStoryBooks)result;
	}

	public static MStoryBooks New2(string[] keys, object[] vals)
	{
		object result;
	...
	public static MStoryBooks Entry(MStoryBooks mst, object id)
	{
		object result;
		if (mst != null)
		{
			mst.setField("Id", id);
			_0024mst_002471[RuntimeServices.UnboxInt32(id)] = mst;
			result = mst;
		}
		else
		{
	...
	public static void AddMst(MStoryBooks mst)
	{
		if (mst != null)
		{
			_0024mst_002471[mst.Id] = mst;
		}
	}

	public static MStoryBooks Create(Hashtable data)
	{
		MStoryBooks mStoryBooks = new MStoryBooks();
		MStoryBooks result;
		if (data == null)
		{
			result = mStoryBooks;
		...
		else
		{
			...
			while (enumerator.MoveNext())
			{
				...
				mStoryBooks.setField((string)obj, data[current]);
			}
			result = mStoryBooks;
		}
		return result;
	...
	public void setField(string key, object val)
	{
		...
		case "StartDate":
		{
			...
			_0024var_0024StartDate = DateTime.Parse((string)obj);
			break;
		}
		case "Title_Ja":
	...
	public static string[] KeyNameList()
	{
		...
		{
			"Id", "Progname", "MStoryId", "Condition_1", "Condition_2", "Condition_3", "Condition_4", "Condition_5", "Condition_6", "Condition_7",
			"Condition_8", "NotCondition_1", "NotCondition_2", "NotCondition_3", "NotCondition_4", "NotCondition_5", "NotCondition_6", "NotCondition_7", "NotCondition_8", "StartDate",
			"Title_Ja", "Title_En", "Text_Ja", "Text_En", "Flag", "NotFlag"
		});
	}
		...
		else
		{
			...
			else
			{
				...
				else
				{
					if (vals[2] != null)
					{
						_0024var_0024MStoryId = MasterBaseClass.ParseInt(vals[2]);
					}
					if (length <= 3)
					{
						result = 3;
					...
					else
					{
						if (vals[3] != null)
						{
							_0024var_0024Condition_1 = MasterBaseClass.ParseInt(vals[3]);
						}
						if (length <= 4)
						{
							result = 4;
						...
						else
						{
							if (vals[4] != null)
							{
								_0024var_0024Condition_2 = MasterBaseClass.ParseInt(vals[4]);
							}
							if (length <= 5)
							{
								result = 5;
							...
							else
							{
								if (vals[5] != null)
								{
									_0024var_0024Condition_3 = MasterBaseClass.ParseInt(vals[5]);
								}
								if (length <= 6)
								{
									result = 6;
								...
								else
								{
									if (vals[6] != null)
									{
										_0024var_0024Condition_4 = MasterBaseClass.ParseInt(vals[6]);
									}
									if (length <= 7)
									{
										result = 7;
									...
									else
									{
										if (vals[7] != null)
										{
											_0024var_0024Condition_5 = MasterBaseClass.ParseInt(vals[7]);
										}
										if (length <= 8)
										{
											result = 8;
										...
										else
										{
											if (vals[8] != null)
											{
												_0024var_0024Condition_6 = MasterBaseClass.ParseInt(vals[8]);
											}
											if (length <= 9)
											{
												result = 9;
											...
											else
											{
												if (vals[9] != null)
												{
													_0024var_0024Condition_7 = MasterBaseClass.ParseInt(vals[9]);
												}
												if (length <= 10)
												{
													result = 10;
												...
												else
												{
													if (vals[10] != null)
													{
														_0024var_0024Condition_8 = MasterBaseClass.ParseInt(vals[10]);
													}
													if (length <= 11)
													{
														result = 11;
													...
													else
													{
														if (vals[11] != null)
														{
															_0024var_0024NotCondition_1 = MasterBaseClass.ParseInt(vals[11]);
														}
														if (length <= 12)
														{
															result = 12;
														...
														else
														{
															if (vals[12] != null)
															{
																_0024var_0024NotCondition_2 = MasterBaseClass.ParseInt(vals[12]);
															}
															if (length <= 13)
															{
																result = 13;
															...
															else
															{
																if (vals[13] != null)
																{
																	_0024var_0024NotCondition_3 = MasterBaseClass.ParseInt(vals[13]);
																}
																if (length <= 14)
																{
																	result = 14;
																...
																else
																{
																	if (vals[14] != null)
																	{
																		_0024var_0024NotCondition_4 = MasterBaseClass.ParseInt(vals[14]);
																	}
																	if (length <= 15)
																	{
																		result = 15;
																	...
																	else
																	{
																		if (vals[15] != null)
																		{
																			_0024var_0024NotCondition_5 = MasterBaseClass.ParseInt(vals[15]);
																		}
																		if (length <= 16)
																		{
																			result = 16;
																		...
																		else
																		{
																			if (vals[16] != null)
																			{
																				_0024var_0024NotCondition_6 = MasterBaseClass.ParseInt(vals[16]);
																			}
																			if (length <= 17)
																			{
																				result = 17;
																			...
																			else
																			{
																				if (vals[17] != null)
																				{
																					_0024var_0024NotCondition_7 = MasterBaseClass.ParseInt(vals[17]);
																				}
																				if (length <= 18)
																				{
																					result = 18;
																				...
																				else
																				{
																					if (vals[18] != null)
																					{
																						_0024var_0024NotCondition_8 = MasterBaseClass.ParseInt(vals[18]);
																					}
																					if (length <= 19)
																					{
																						result = 19;
																					...
																					else
																					{
																						if (vals[19] != null)
																						{
																							_0024var_0024StartDate = MasterBaseClass.ParseDateTime(vals[19]);
																						}
																						if (length <= 20)
																						{
																							result = 20;
																								...
																								else
																								{
																									...
																									else
																									{
																										...
																										else
																										{
																											if (vals[24] != null)
																											{
																												_0024var_0024Flag = MasterBaseClass.ParseInt(vals[24]);
																											}
																											if (length <= 25)
																											{
																												result = 25;
																											...
																											else
																											{
																												if (vals[25] != null)
																												{
																													_0024var_0024NotFlag = MasterBaseClass.ParseInt(vals[25]);
																												}
																												int num = 26;
																												result = num;
																											}
