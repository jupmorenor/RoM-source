...
[Serializable]
public class MAreas : MerlinMaster
{
	...
	public bool _0024var_0024No1stIconDemo;

	public string _0024var_0024Position;

	public int _0024var_0024TempFlag;

	public EnumAreaTypes _0024var_0024JumpType;
	...
	[NonSerialized]
	private static Dictionary<int, MAreas> _0024mst_002464 = new Dictionary<int, MAreas>();

	[NonSerialized]
	private static MAreas[] All_cache;
	...
	public bool No1stIconDemo => _0024var_0024No1stIconDemo;

	public string Position => _0024var_0024Position;
	...
	public EnumAreaTypes JumpType => _0024var_0024JumpType;

	public static MAreas[] All
	{
		get
		{
			MAreas[] result;
			if (All_cache == null)
			{
				MerlinMaster.GetHandler("MAreas");
				MAreas[] array = (MAreas[])Builtins.array(typeof(MAreas), _0024mst_002464.Values);
				if (array.Length > 0)
				{
					All_cache = array;
					result = All_cache;
	...
	public MAreas()
	{
		_0024var_0024BeginPeriod = DateTime.Parse("2001/01/01");
		_0024var_0024EndPeriod = DateTime.Parse("2099/01/01");
	}

	public override string ToString()
	{
		return new StringBuilder("MAreas(").Append((object)Id).Append(",").Append(Progname)
			.Append(")")
			.ToString();
	}
	...
	public static MAreas Get(int _id)
	{
		MerlinMaster.GetHandler("MAreas");
		return (!_0024mst_002464.ContainsKey(_id)) ? null : _0024mst_002464[_id];
	}

	public static void Unload()
	{
		_0024mst_002464.Clear();
		All_cache = null;
	}

	public static MAreas New(Hashtable data)
	{
		object result;
		...
		{
			MAreas mAreas = Create(data);
			if (!_0024mst_002464.ContainsKey(mAreas.Id))
			{
				_0024mst_002464[mAreas.Id] = mAreas;
			}
			result = mAreas;
		}
	...
	public static MAreas New2(string[] keys, object[] vals)
	{
		object result;
	...
	public static MAreas Entry(MAreas mst, object id)
	{
		object result;
		if (mst != null)
		{
			mst.setField("Id", id);
			_0024mst_002464[RuntimeServices.UnboxInt32(id)] = mst;
			result = mst;
		}
		else
		{
	...
	public static void AddMst(MAreas mst)
	{
		if (mst != null)
		{
			_0024mst_002464[mst.Id] = mst;
		}
	}

	public static MAreas Create(Hashtable data)
	{
		MAreas mAreas = new MAreas();
		MAreas result;
		if (data == null)
		{
			result = mAreas;
		...
		else
		{
			...
			while (enumerator.MoveNext())
			{
				...
				mAreas.setField((string)obj, data[current]);
			}
			result = mAreas;
		}
		return result;
	...
	public void setField(string key, object val)
	{
		...
		case "Icon":
			...
			break;
		case "No1stIconDemo":
			_0024var_0024No1stIconDemo = MasterBaseClass.ToBool(val);
			break;
		case "Position":
			_0024var_0024Position = MasterBaseClass.ToStringValue(val);
			break;
		case "TempFlag":
			_0024var_0024TempFlag = MasterBaseClass.ToInt(val);
			break;
		case "JumpType":
			if (typeof(EnumAreaTypes).IsEnum)
			{
				_0024var_0024JumpType = (EnumAreaTypes)MasterBaseClass.ToEnum(val);
			}
			break;
		}
	}
	...
	public static string[] KeyNameList()
	{
		...
		{
			"Id", "Progname", "AreaGroup", "DisplayName", "Explain", "DisplayName_En", "Explain_En", "Condition_1", "Condition_2", "Condition_3",
			"Condition_4", "Condition_5", "Condition_6", "Condition_7", "Condition_8", "NotCondition_1", "NotCondition_2", "NotCondition_3", "NotCondition_4", "NotCondition_5",
			"NotCondition_6", "NotCondition_7", "NotCondition_8", "BeginPeriod", "EndPeriod", "Icon", "No1stIconDemo", "Position", "TempFlag", "JumpType"
		});
	}
		...
		else
		{
			...
			else
			{
				...
				else
				{
					if (vals[2] != null)
					{
						_0024var_0024AreaGroup = MasterBaseClass.ParseInt(vals[2]);
					}
					if (length <= 3)
					{
						result = 3;
						...
						else
						{
							...
							else
							{
								...
								else
								{
									if (vals[6] != null)
									{
										_0024var_0024Explain_En = vals[6];
									}
									if (length <= 7)
									{
										result = 7;
									...
									else
									{
										if (vals[7] != null)
										{
											_0024var_0024Condition_1 = MasterBaseClass.ParseInt(vals[7]);
										}
										if (length <= 8)
										{
											result = 8;
										...
										else
										{
											if (vals[8] != null)
											{
												_0024var_0024Condition_2 = MasterBaseClass.ParseInt(vals[8]);
											}
											if (length <= 9)
											{
												result = 9;
											...
											else
											{
												if (vals[9] != null)
												{
													_0024var_0024Condition_3 = MasterBaseClass.ParseInt(vals[9]);
												}
												if (length <= 10)
												{
													result = 10;
												...
												else
												{
													...
													else
													{
														if (vals[11] != null)
														{
															_0024var_0024Condition_5 = MasterBaseClass.ParseInt(vals[11]);
														}
														if (length <= 12)
														{
															result = 12;
														...
														else
														{
															if (vals[12] != null)
															{
																_0024var_0024Condition_6 = MasterBaseClass.ParseInt(vals[12]);
															}
															if (length <= 13)
															{
																result = 13;
															...
															else
															{
																if (vals[13] != null)
																{
																	_0024var_0024Condition_7 = MasterBaseClass.ParseInt(vals[13]);
																}
																if (length <= 14)
																{
																	result = 14;
																...
																else
																{
																	if (vals[14] != null)
																	{
																		_0024var_0024Condition_8 = MasterBaseClass.ParseInt(vals[14]);
																	}
																	if (length <= 15)
																	{
																		result = 15;
																	...
																	else
																	{
																		if (vals[15] != null)
																		{
																			_0024var_0024NotCondition_1 = MasterBaseClass.ParseInt(vals[15]);
																		}
																		if (length <= 16)
																		{
																			result = 16;
																		...
																		else
																		{
																			if (vals[16] != null)
																			{
																				_0024var_0024NotCondition_2 = MasterBaseClass.ParseInt(vals[16]);
																			}
																			if (length <= 17)
																			{
																				result = 17;
																			...
																			else
																			{
																				if (vals[17] != null)
																				{
																					_0024var_0024NotCondition_3 = MasterBaseClass.ParseInt(vals[17]);
																				}
																				if (length <= 18)
																				{
																					result = 18;
																				...
																				else
																				{
																					if (vals[18] != null)
																					{
																						_0024var_0024NotCondition_4 = MasterBaseClass.ParseInt(vals[18]);
																					}
																					if (length <= 19)
																					{
																						result = 19;
																					...
																					else
																					{
																						if (vals[19] != null)
																						{
																							_0024var_0024NotCondition_5 = MasterBaseClass.ParseInt(vals[19]);
																						}
																						if (length <= 20)
																						{
																							result = 20;
																						...
																						else
																						{
																							if (vals[20] != null)
																							{
																								_0024var_0024NotCondition_6 = MasterBaseClass.ParseInt(vals[20]);
																							}
																							if (length <= 21)
																							{
																								result = 21;
																							...
																							else
																							{
																								if (vals[21] != null)
																								{
																									_0024var_0024NotCondition_7 = MasterBaseClass.ParseInt(vals[21]);
																								}
																								if (length <= 22)
																								{
																									result = 22;
																								...
																								else
																								{
																									if (vals[22] != null)
																									{
																										_0024var_0024NotCondition_8 = MasterBaseClass.ParseInt(vals[22]);
																									}
																									if (length <= 23)
																									{
																										result = 23;
																									...
																									else
																									{
																										if (vals[23] != null)
																										{
																											_0024var_0024BeginPeriod = MasterBaseClass.ParseDateTime(vals[23]);
																										}
																										if (length <= 24)
																										{
																											result = 24;
																										...
																										else
																										{
																											if (vals[24] != null)
																											{
																												_0024var_0024EndPeriod = MasterBaseClass.ParseDateTime(vals[24]);
																											}
																											if (length <= 25)
																											{
																												result = 25;
																											...
																											else
																											{
																												...
																												else
																												{
																													if (vals[26] != null)
																													{
																														_0024var_0024No1stIconDemo = MasterBaseClass.ParseBool(vals[26]);
																													}
																													if (length <= 27)
																													{
																														result = 27;
																													...
																													else
																													{
																														...
																														else
																														{
																															if (vals[28] != null)
																															{
																																_0024var_0024TempFlag = MasterBaseClass.ParseInt(vals[28]);
																															}
																															if (length <= 29)
																															{
																																result = 29;
																															...
																															{
																																if (vals[29] != null && typeof(EnumAreaTypes).IsEnum)
																																{
																																	_0024var_0024JumpType = (EnumAreaTypes)MasterBaseClass.ParseEnum(vals[29]);
																																}
																																int num = 30;
																																result = num;
																															}
