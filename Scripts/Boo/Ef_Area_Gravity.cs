...
[Serializable]
public class Ef_Area_Gravity : Ef_Base
{
	public float radius;
	...
	public void Start()
	{
		...
		if (!smokeObj)
		{
			smokeObj = transform.Find("b00/Ef_Area_Gravity_Smoke");
		}
		if (!parentObj)
		{
	...
	public void Update()
	{
		...
		if ((bool)smokeObj)
		{
			smokeObj.localRotation = Quaternion.Euler(0f, 360f * deltaTime, 0f) * smokeObj.localRotation;
		}
	}
