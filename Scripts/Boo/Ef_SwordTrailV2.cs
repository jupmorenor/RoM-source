...
[Serializable]
public class Ef_SwordTrailV2 : Ef_Base
{
	...
	public void LateUpdate()
	{
		...
		if (slash)
		{
			SlashTrack(slashTime);
			slash = false;
		}
	}

	public void SlashTrack(float time)
	{
		if (time != 0f)
		{
			if (!ready)
	...
	public void UpdateTransform()
	{
		...
		if (!(num * num <= upwards.sqrMagnitude))
		{
			num3 *= -1f;
		}
	...
	public void UpdateColor()
	{
		...
		{
			mat.color = color * colorAnim.Evaluate(time);
		}
	}
